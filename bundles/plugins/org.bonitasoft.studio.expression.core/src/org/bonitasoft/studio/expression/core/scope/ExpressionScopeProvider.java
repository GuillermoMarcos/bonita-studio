...
public class ExpressionScopeProvider {
    ...
    private ExpressionScope resolveScope(ModelLocation location) {
        final ExpressionScopeResolver resolver = findResolver(location);
        return resolver.applyTo(location);
    }

    private ExpressionScopeResolver findResolver(ModelLocation location) {
